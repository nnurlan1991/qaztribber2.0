...
- Android: `https://github.com/nnurlan1991/qaztribber_mobile/releases/latest/download/QazTriber.apk`
...
4. Загрузить в Release мобильного репо:
   ...
   gh release upload v1.x.0 \
     "/Users/market/Documents/проекты программиста/qaztribber_mobile/android_app/app/build/outputs/apk/debug/app-debug.apk#QazTriber.apk" \
     --repo nnurlan1991/qaztribber_mobile --clobber
   ```
   (имя файла в Release = `QazTriber.apk`, без версии — чтобы лендинг всегда качал latest)
...
- Ссылки используют `releases/latest/download/` — автоматически берут последний релиз
- Desktop: `https://github.com/nnurlan1991/qaztribber2.0/releases/latest/download/`
- Mobile: `https://github.com/nnurlan1991/qaztribber_mobile/releases/latest/download/QazTriber.apk`
- Обновлять лендинг нужно только если меняется имя файла или репозиторий

### Финальная проверка
- `gh release view v1.x.0` (desktop) → .dmg + .exe
- `gh release view v1.x.0 --repo nnurlan1991/qaztribber_mobile` → QazTriber.apk
