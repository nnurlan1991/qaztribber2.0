...
const ru: Dict = {
  ...
  "session.geminiToastTitle": "Готово к обработке в Gemini",
  "session.geminiToastBody": "Отправьте текст в Gemini, чтобы получить саммари и сформировать итоговый готовый документ",
  "session.geminiToastAction": "Открыть Gemini",
  ...
  "onboarding.download": "Скачать модель",
  "onboarding.skip": "Пропустить",
  "onboarding.model220m": "Быстрая — 220M (~880 МБ)",
  "onboarding.model600m": "Точная — 600M (~2.3 ГБ)",
  "onboarding.model220mDesc": "Быстрая обработка — в 3 раза быстрее реального времени. Качество немного ниже, подходит для черновых заметок и быстрых расшифровок.",
  "onboarding.model600mDesc": "Высокая точность распознавания. Идеальна для важных совещаний и документов, где качество критично. Работает медленнее — примерно в реальном времени.",
  "onboarding.selectModel": "Выберите модель для скачивания",
  "onboarding.modelBadgeFast": "Быстрее",
  "onboarding.modelBadgeAccurate": "Точнее",
...
const kz: Dict = {
  ...
  "session.geminiToastTitle": "Gemini-де өңдеуге дайын",
  "session.geminiToastBody": "Мәтінді Gemini-ге жіберіп, қысқаша мазмұн мен дайын құжат жасаңыз",
  "session.geminiToastAction": "Gemini-ді ашу",
  ...
  "onboarding.download": "Модельді жүктеу",
  "onboarding.skip": "Өткізу",
  "onboarding.model220m": "Жылдам — 220M (~880 МБ)",
  "onboarding.model600m": "Дәл — 600M (~2.3 ГБ)",
  "onboarding.model220mDesc": "Жылдам өңдеу — нақты уақыттан 3 есе жылдамырақ. Сапасы сәл төмен, нобайлар мен жылдам жазбалар үшін жарамды.",
  "onboarding.model600mDesc": "Жоғары тану дәлдігі. Маңызды отырыстар мен құжаттар үшін идеалды. Баялырақ жұмыс істейді — шамамен нақты уақытта.",
  "onboarding.selectModel": "Жүктеу үшін модельді таңдаңыз",
  "onboarding.modelBadgeFast": "Жылдамырақ",
  "onboarding.modelBadgeAccurate": "Дәлірек",
