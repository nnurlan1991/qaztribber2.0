...
function MarkDark({ size, className }: { size: number; className: string }) {
  return (
    ...
    >
      ...
      <path d="M87 162C87 158.686 84.3137 156 81 156C77.6863 156 75 158.686 75 162V210C75 213.314 77.6863 216 81 216C84.3137 216 87 213.314 87 210V162Z" fill="#210509" />
      ...
      <path d="M159 122C159 118.686 156.314 116 153 116C149.686 116 147 118.686 147 122V250C147 253.314 149.686 256 153 256C156.314 256 159 253.314 159 250V122Z" fill="#210509" />
      ...
      <path d="M195 122C195 118.686 192.314 116 189 116C185.686 116 183 118.686 183 122V250C183 253.314 185.686 256 189 256C192.314 256 195 253.314 195 250V122Z" fill="#210509" />
      ...
      <path d="M267 162C267 158.686 264.314 156 261 156C257.686 156 255 158.686 255 162V210C255 213.314 257.686 216 261 216C264.314 216 267 213.314 267 210V162Z" fill="#210509" />
      ...
      <path d="M153 97C156.314 97 159 94.3137 159 91C159 87.6863 156.314 85 153 85C149.686 85 147 87.6863 147 91C147 94.3137 149.686 97 153 97Z" fill="#210509" />
      <path d="M189 97C192.314 97 195 94.3137 195 91C195 87.6863 192.314 85 189 85C185.686 85 183 87.6863 183 91C183 94.3137 185.686 97 189 97Z" fill="#210509" />
      <path d="M55 115.919C63.7078 93.2806 79.0714 73.8128 99.0653 60.0815C119.059 46.3501 142.745 39 167 39C191.255 39 214.941 46.3501 234.935 60.0815C254.929 73.8128 270.292 93.2806 279 115.919" stroke="#350A11" strokeWidth="5" strokeLinecap="round" />
      <defs>
